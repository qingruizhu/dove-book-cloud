package com.dove.common.shiro.config;
...
import com.dove.common.shiro.realm.PhoneShiroRealm;
import com.dove.common.shiro.realm.UserNameShiroRealm;
...
//        manager.setAuthenticator(authenticator());
        manager.setRealms(Arrays.asList(userNameShiroRealm(), phoneShiroRealm(), jwtShiroRealm()));
    ...
    @Bean
    public UserNameShiroRealm userNameShiroRealm() {
        UserNameShiroRealm userNameShiroRealm = new UserNameShiroRealm();
        return userNameShiroRealm;
    }
